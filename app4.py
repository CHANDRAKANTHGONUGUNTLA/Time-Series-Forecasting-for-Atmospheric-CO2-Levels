...
data2=pd.read_csv('C:/Users/DELL/Desktop/co2.csv')
...
option = st.sidebar.selectbox('Please select an option', ('','Show Data', 'Predicted Data'))
...
periods_input = st.number_input('How many years forecast do you want?', min_value = 1, max_value = 365)
